package org.paul.test.springboot.app.models;


import org.paul.test.springboot.app.exceptions.DineroInsuficienteException;
...
public class Cuenta {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // para pruebas en memoria se usa identity
    private Long id;
